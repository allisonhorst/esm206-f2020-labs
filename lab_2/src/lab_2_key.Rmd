---
title: "ESM 206 Lab 2 Part 1"
subtitle: "Wrangling continued, pivot_longer(), ggplot2 customization"
...
- More data wrangling (arrange, fct_reorder)
...
Add superscripts with two ^: like^this^

Or subscripts with two ~: like~this~
...
- Paste the image location into the parentheses in this format: 

`![](paste_image_location_here.png)`
